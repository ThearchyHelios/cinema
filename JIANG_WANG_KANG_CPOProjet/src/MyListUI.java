...
public class MyListUI extends DefaultListCellRenderer {
    public Component getListCellRendererComponent(JList<? extends Object> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        File DVD_png = new File("JIANG_WANG_KANG_CPOProjet/src/DVD.png");
        File Bray_png = new File("JIANG_WANG_KANG_CPOProjet/src/Bray.png");
        File Digital_png = new File("JIANG_WANG_KANG_CPOProjet/src/Digital.png");
